...
//     const { products, grandTotal, totalPrice, tax } = useSelector((store) => store.cart);
...
//     const finalAmount = grandTotal + shippingFee;
...
//             paymentMethod: paymentMethod === 'MANUAL' ? "Manual Payment" : "Cash on Delivery"
//         };
...
//                 //  THE FIX: Redirect based on payment method
//                 if (paymentMethod === 'MANUAL') {
//                     // Send to Chat and pass the real Order ID
...
//                     });
//                 } else {
//                     // Send to normal user orders page
...
//                             <input required name="state" placeholder="State" className="border p-3 rounded-lg w-full focus:outline-none focus:border-indigo-500 bg-gray-50 text-sm" onChange={onChange} />
//                         </div>
...
//                             <input required name="country" placeholder="Country" className="border p-3 rounded-lg w-full focus:outline-none focus:border-indigo-500 bg-gray-50 text-sm" onChange={onChange} />
//                         </div>

//                         <input required type="text" name="phone" placeholder="Mobile Number" className="border p-3 rounded-lg w-full mb-4 focus:outline-none focus:border-indigo-500 bg-gray-50 text-sm" onChange={onChange} />
...
//                             {/* MANUAL PAYMENT LOGIC ADDED HERE */}
//                             {paymentMethod === 'MANUAL' && (
//                                 <div className="mt-5 bg-gray-50 p-6 rounded-2xl shadow-md border border-gray-100">
//                                     <h4 className="text-sm font-bold uppercase tracking-wider mb-4 text-gray-800">Manual Payment</h4>
//                                     <div className="flex justify-between items-center mb-5">
//                                         <span className="text-sm text-gray-500">Total Payable Amount:</span>
//                                         <span className="text-xl font-bold text-indigo-600">${finalAmount.toFixed(2)}</span>
//                                     </div>
//                                     <button
//                                         type="submit" //  Changed to submit so it triggers handleFinalOrder
...
//                                     >
//                                         {isProcessing ? "PROCESSING..." : "Start Chat for Payment"}
//                                     </button>
//                                 </div>
//                             )}
//                         </div>
...
//                                 {products.map((item) => {
//                                     const checkoutImg = Array.isArray(item.image) ? item.image[0] : item.image;
//                                     return (
//                                         <div key={item._id} className="flex gap-3 items-center">
//                                             <img src={checkoutImg} alt={item.name} className="w-12 h-12 object-cover rounded-md border" />
...
//                             {/* Only show this button if COD is selected */}
//                             {paymentMethod === 'COD' && (
//                                 <button 
//                                     type="submit"
