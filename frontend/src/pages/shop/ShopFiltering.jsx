...
const ShopFiltering = ({ filters, filtersState, setFiltersState, clearFilters }) => {
    ...
    return (
        /* ✅ Sticky logic added: sticky top-20 aur h-fit se ye scroll ke sath move karega */
        <div className="sticky top-16 h-fit space-y-6 flex-shrink-0 w-full md:w-64 bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
            <div className="flex items-center justify-between mb-2">
                <h3 className="text-xl font-bold text-gray-800">Shop Filters</h3>
                <button className="text-sm text-primary hover:underline font-medium" onClick={clearFilters}>
                    Clear All
