...
const Register = () => {
  ...
  const [showPassword, setShowPassword] = useState(false); // ✅ Eye button ke liye naya state toggle logic
            ...
            <form onSubmit={handleRegister} className='space-y-4'>
              ...
              <div className='group'>
                <div className='relative'>
                  ...
                  <input 
                    type={showPassword ? "text" : "password"} // ✅ Type dynamically badlegi text ya password mein
                    value={password}
                    ...
                    required 
                  />
                  {/* ✅ Eye icon button toggle ke sath */}
                  <button
                    type="button"
